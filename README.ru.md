...
|------|----------------------|-------------------|
| **Универсальный выбор** | **Nanobot** | Золотая середина: Python, активное комьюнити, поддержка мульти-инстансов, не очень требовательный к железу (RAM 300MB+) |
| **Максимум мощи** | **OpenClaw** | Стандарт и этим всё сказано. 15+ каналов связи, голос, работа с Canvas, RAM 2GB+ |
| **Для слабых машин** | **ZeroClaw** | Rust-движок, потребляет всего ~5MB RAM |
| **IoT и Edge** | **PicoClaw** | Запускается на железе за $10 (ESP32 и аналоги) |
| **Безопасность** | **IronClaw** | Песочница на WebAssembly и параноидальный подход к приватности |
| **Минимализм** | **TinyClaw** | Всего 400 строк кода. Идеально для обучения |
...
|--------|---------|------|-----|-------------|
| **OpenClaw** | 306k | TypeScript | AI-агент | Базовый проект, поддержка MCP и AWS EC2 |
| **Nanobot** | 32k | Python | AI-агент | Multi-instance, ультра-легкий |
| **ZeroClaw** | 26k | Rust | AI-агент | Потребление памяти ~5MB, быстрый старт |
| **PicoClaw** | 24k | Go | Edge/IoT | Работает как нода в gateway, дешевое железо |
| **AstrBot** | 22k | Python | Chatbot | Фокус на IM-платформы (TG, WhatsApp) |
| **NanoClaw** | 21k | TypeScript | AI-агент | Контейнеризация, фокус на бизнес-мессенджеры |
| **IronClaw** | 9.6k | Rust | AI-агент | WASM sandbox, максимальная изоляция |
...
- **NullClaw** (Zig): Фантастические показатели. Бинарник 678KB, запуск <2мс. Подходит для Arduino и RPi.
- **MimiClaw** (C): Работает на ESP32-S3 bare-metal. Цена решения ~$5.
- **SubZeroClaw** (C): Всего 54KB.

### Безопасность и отказоустойчивость

- **ZeptoClaw**: 7-уровневая система безопасности на Rust.
- **BeamClaw**: Написан на Erlang/OTP для распределённых систем.
- **Safeclaw**: Работает без LLM (intent recognition), что гарантирует 100% предсказуемость.
